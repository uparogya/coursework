    ...
    public void playGame() {
        ...
        while(true) {
            ...
            if (leftSum >= rightSum) {
                ...
                computerChoice = coins.getLength()-1;
            }
            ...
            System.out.print("Enter Your Choice (0/"+ (coins.getLength()-1) +"): ");
            int humanChoice = keyboard.nextInt();
            if(humanChoice != 0 && humanChoice != coins.getLength()-1){
                System.err.println("Only 1 or " + (coins.getLength()-1) + " are allowed!");
                System.exit(1);
            }
