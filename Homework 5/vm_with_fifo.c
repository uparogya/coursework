...
int fifo_ptable_replacement_index = 0;
...
int insert_frame_to_page_table(int page_number) {
	...
	if (current_page_table_length < PAGE_FRAMES) {
		temp_current_tlb_assignment =  page_table[current_page_table_length].ptable_page_number;
		page_table[current_page_table_length].ptable_page_number = page_number;
		page_table[current_page_table_length].ptable_frame_number = current_free_physical_index;
		index_in_page_table = current_page_table_length;
	} else {
		temp_current_tlb_assignment =  page_table[fifo_ptable_replacement_index].ptable_page_number;
		int current_temp_physical_memory_index = fifo_ptable_replacement_index * CHUNK;
		page_table[fifo_ptable_replacement_index].ptable_page_number = page_number;
		page_table[fifo_ptable_replacement_index].ptable_frame_number = current_temp_physical_memory_index;
		index_in_page_table = fifo_ptable_replacement_index;
		fifo_ptable_replacement_index = (fifo_ptable_replacement_index + 1) % PAGE_FRAMES;
